...
function ncclGetErrorString(result)
    @check @ccall librccl.ncclGetErrorString(result::ncclResult_t)::Cstring
end

function pncclGetErrorString(result)
    @check @ccall librccl.pncclGetErrorString(result::ncclResult_t)::Cstring
end

function ncclGetLastError(comm)
    @check @ccall librccl.ncclGetLastError(comm::ncclComm_t)::Cstring
end

function pncclGetLastError(comm)
    @check @ccall librccl.pncclGetLastError(comm::ncclComm_t)::Cstring
end
